            ...
            <nav class="text-right">
                ...
                <ul class="text-sm mt-6 hidden md:block" id="menu">
                    ...
                    <li class="py-1border-r-4 border-white">
                        <a href="#" class="px-4">
                            <span>Contact</span>
                            <svg class="w-5 inline-block ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        </a>
                    </li>
                </ul>
            </nav>
        ...
        <main class="px-16 py-6 bg-gray-100 md:col-span-4">
            ...
            <div>
                ...
                <div class="mt-8 grid lg:grid-cols-3 gap-10">
                    <!-- cards go here -->
                    <div class="card">
                        <img class="w-full h-32 sm:h-48 object-cover" src="{{ asset('img/stew.jpg') }}" alt="stew">
                        <div class="m-4">
                    ...
                    <div class="card">
                        <img class="w-full h-32 sm:h-48 object-cover" src="{{ asset('img/noodles.jpg') }}" alt="noodles">
                        <div class="m-4">
                    ...
                    <div class="card">
                        <img class="w-full h-32 sm:h-48 object-cover" src="{{ asset('img/curry.jpg') }}" alt="curry">
                        <div class="m-4">
